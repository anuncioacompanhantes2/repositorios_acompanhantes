...
Now I'll update the header to include the theme toggle:

<boltArtifact id="update-header-theme" title="Update header with theme toggle">
<boltAction type="file" filePath="components/header.tsx">"use client";
